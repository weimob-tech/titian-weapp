/* eslint-disable @titian-design/check-life-items */ import openType from '../behaviors/open-type';
...
BasicComponent({
    ...
    observers: {
        'color, variant, type': function fn(color, variant, type) {
    ...
    methods: {
        ...
        setSubColor (color, variant, type) {
