...
var ArrowIconNameEnum;
(function(ArrowIconNameEnum) {
    ArrowIconNameEnum["Left"] = 'tooltipsarrow-left';
    ArrowIconNameEnum["Right"] = 'tooltipsarrow-right';
    ArrowIconNameEnum["Center"] = 'tooltipsarrow-mid';
})(ArrowIconNameEnum || (ArrowIconNameEnum = {}));
BasicComponent({
    options: {
        virtualHost: true
    },
    ...
    methods: {
        ...
        calculate (cb) {
            ...
            query.select('.titian-tooltip').fields({
                size: true,
                rect: true
            }).select('.titian-tooltip-content').fields({
                size: true,
                computedStyle: [
                    'borderRadius'
                ]
            }).select('.titian-tooltip-arrow').fields({
                size: true
                ...
                if (isLeft) {
                    iconName = 'tooltipsarrow-left';
                } else if (isRight) {
                    iconName = 'tooltipsarrow-right';
                } else {
                    iconName = 'tooltipsarrow-mid';
                }
                this.setData({
                    down,
                    top,
