/* eslint-disable class-methods-use-this */ import BasicComponent from '../common/basic/BasicComponent';
...
BasicComponent({
    ...
    observers: {
        ...
        'code,value,options,cascade': function(code, value, options, cascade) {
    ...
    methods: {
        ...
        async createCascade () {
            ...
            this.cascadeHelper = new Cascade({
                tabs,
                options,
                getOptions,
                cascade
